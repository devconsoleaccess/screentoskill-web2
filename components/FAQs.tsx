...
export default function FAQs() {
  ...
  return (
    <section
      id="faqs"
      className="relative py-14 sm:py-20 lg:py-24 bg-slate-50/40 border-b border-[#E5E7EB] overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-5 relative flex justify-center max-w-sm mx-auto lg:max-w-none w-full">
            <div className="relative w-full max-w-[280px] sm:max-w-[320px] aspect-[482/650] rounded-2xl overflow-hidden shadow-sm border border-[#E5E7EB] group">
            ...
            <div className="absolute -bottom-4 -right-2 bg-white border border-[#E5E7EB] p-3.5 rounded-xl shadow-xs max-w-[160px] hidden sm:block">
              <span className="text-[10px] uppercase font-mono tracking-wider text-[#22C55E] font-bold block">
                PARENT TIP
              </span>
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="text-left space-y-2.5">
              <span className="inline-flex items-center space-x-2 px-3 py-1 rounded-full border border-[#E5E7EB]-100 bg-emerald-50 text-[10px] sm:text-[11px] font-mono font-bold text-[#22C55E]">
                <span>Questions & Answers</span>
              </span>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-slate-900 tracking-tight">
                Frequently asked{" "}
                <HighlightUnderline>questions</HighlightUnderline>
              </h2>
            ...
            <div className="space-y-3">
              {[
                ...
                return (
                  <div
                    key={index}
                    className="bg-white border border-[#E5E7EB] rounded-xl overflow-hidden shadow-2xs transition-all hover:shadow-xs"
                  >
                    <button
