...
export default function Footer() {
  return (
    <footer className="relative bg-white border-t border-slate-200/60 pt-16 pb-12 text-sm overflow-hidden" id="main-footer">
      {/* Transparent responsive glow blobs behind layout */}
      <div className="absolute bottom-[20%] left-[-5%] w-[350px] h-[350px] rounded-full bg-[#00D084]/4 blur-[100px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-12 gap-8 lg:gap-12 pb-12">
          ...
          <div className="col-span-12 md:col-span-5 lg:col-span-4 text-left space-y-4">
            <div>
              <Link href="/" className="flex items-center space-x-2.5 mb-3.5 hover:opacity-95 transition-all cursor-pointer">
            ...
            <div className="flex items-center space-x-2 py-0.5 select-none font-sans">
              <div className="flex text-amber-400 space-x-1.5 focus:outline-none">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-4 h-4 fill-current shrink-0" viewBox="0 0 24 24">
                    <path d="M12 17.27L18.18 21l-1.64-7.03L22 9.24l-7.19-.61L12 2 9.19 8.63 2 9.24l5.46 4.73L5.82 21z" />
                  </svg>
                ))}
              </div>
              <span className="text-[12px] font-bold text-slate-400 tracking-wide font-mono">
                4.9 <span className="text-slate-300 font-light mx-1">|</span> 256 Reviews
              </span>
            </div>
          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-8 grid grid-cols-2 sm:grid-cols-4 gap-8">
            ...
            <div className="space-y-4 text-left">
              <span className="block text-[10px] sm:text-[11px] font-bold tracking-wider text-slate-400 uppercase font-mono">Platform</span>
              <ul className="space-y-3 text-xs sm:text-sm font-normal text-slate-600 font-sans">
                <li>
                  <Link href="/#how-it-works" className="hover:text-emerald-500 transition-colors block">
                    Core Methodology
                  </Link>
                </li>
                <li>
                  <Link href="/#brain-impact" className="hover:text-emerald-500 transition-colors block">
                    Brain Impact
                  </Link>
                </li>
                <li>
                  <Link href="/#parent-portal" className="hover:text-emerald-500 transition-colors block">
                    Parent Analytics
                  </Link>
                </li>
                <li>
                  <Link href="/#mandatory-permissions" className="hover:text-emerald-500 transition-colors block">
                    Accessibility Setup
                  </Link>
                </li>
              </ul>
            ...
            {/* Solutions column */}
            <div className="space-y-4 text-left">
              <span className="block text-[10px] sm:text-[11px] font-bold tracking-wider text-slate-400 uppercase font-mono">Solutions</span>
              <ul className="space-y-3 text-xs sm:text-sm font-normal text-slate-600 font-sans">
                <li>
                  <Link href="/#download" className="hover:text-emerald-500 transition-colors block">
                    Family Plan
                  </Link>
                </li>
                <li>
                  <Link href="/case-study" className="hover:text-emerald-500 transition-colors block font-semibold text-[#00D084]">
                    Interactive Case Study
                  </Link>
                </li>
                <li>
                  <Link href="/#download" className="hover:text-emerald-500 transition-colors block text-left">
                    Direct Download
                  </Link>
                </li>
              </ul>
            ...
            {/* Explore column */}
            <div className="space-y-4 text-left">
              <span className="block text-[10px] sm:text-[11px] font-bold tracking-wider text-slate-400 uppercase font-mono">Explore</span>
              <ul className="space-y-3 text-xs sm:text-sm font-normal text-slate-600 font-sans">
                <li>
                  <Link href="/#why-screentoskill" className="hover:text-emerald-500 transition-colors block">
                    Why ScreenToSkill
                  </Link>
                </li>
                <li>
                  <Link href="/#comparison" className="hover:text-emerald-500 transition-colors block">
                    Before & After
                  </Link>
                </li>
                <li>
                  <Link href="/#age-adapted" className="hover:text-emerald-500 transition-colors block">
                    Age-Adapted Focus
                  </Link>
                </li>
              </ul>
            ...
            {/* Company columns */}
            <div className="space-y-4 text-left">
              <span className="block text-[10px] sm:text-[11px] font-bold tracking-wider text-slate-400 uppercase font-mono">Company</span>
              <ul className="space-y-3 text-xs sm:text-sm font-normal text-slate-600 font-sans">
                <li>
                  <Link href="/#vision" className="hover:text-emerald-500 transition-colors block">
                    Science & Vision
                  </Link>
                </li>
                <li>
                  <Link href="/#faqs" className="hover:text-emerald-500 transition-colors block">
                    Curriculum FAQs
                  </Link>
                </li>
                <li>
                  <Link href="/#download" className="hover:text-emerald-500 transition-colors block font-medium">
                    Get App Free
                  </Link>
                </li>
              </ul>
        ...
        <div className="mt-12 pt-8 border-t border-slate-150 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center space-x-2.5 select-none">
            ...
            <a 
              href="#facebook" 
              className="w-9 h-9 rounded-xl border border-slate-200 hover:border-emerald-500 hover:bg-emerald-50/50 flex items-center justify-center text-slate-500 hover:text-emerald-500 transition-all cursor-pointer group hover:scale-[1.02]"
              aria-label="Facebook"
            >
