...
export default function BeforeAfter() {
  return (
    <section
      id="comparison"
      className="relative py-14 sm:py-20 lg:py-24 bg-[#FBFDFE] border-b border-[#E5E7EB] overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto mb-10 sm:mb-14">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full border border-[#E5E7EB] bg-white text-[10px] sm:text-[11px] font-mono font-bold text-slate-500 tracking-wider uppercase select-none">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-slate-900 tracking-tight leading-tight animate-fade-in">
            How ScreenToSkill <HighlightUnderline>Restores</HighlightUnderline>{" "}
            Balance
          </h2>
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed font-normal">
            We don&apos;t block devices entirely or cause daily friction. We
            swap passive consumption with gamified curriculum challenges.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch pt-2">
          {/* Before view card */}
          <div className="group relative bg-white border border-[#E5E7EB] hover:border-slate-200 rounded-2xl hover:shadow-xl transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-2xs">
            ...
            <div className="p-5 sm:p-6 flex-1 flex flex-col justify-between space-y-6">
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-start space-x-3.5">
                  ...
                  <div className="text-xs sm:text-[13px] font-normal text-slate-500 leading-relaxed">
                    <span className="font-bold text-[#1E293B] block text-sm mb-0.5">
                      Endless Brain Rot Scrolling
                    </span>
                    Children remain glued to reels, gaming slots and videos for
                    hours without a structured cooling period.
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div className="text-xs sm:text-[13px] font-normal text-slate-500 leading-relaxed">
                    <span className="font-bold text-[#1E293B] block text-sm mb-0.5">
                      Passive Entertainment Mindset
                    </span>
                    Passive, mindless ingestion of video feeds limits cognitive
                    imagination or logical recall loops.
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div className="text-xs sm:text-[13px] font-normal text-slate-500 leading-relaxed">
                    <span className="font-bold text-[#1E293B] block text-sm mb-0.5">
                      Constant Screentime Arguments
                    </span>
                    Parents and kids enter daily disputes over rules, app limit
                    agreements, and device confiscations.
                  </div>
                </div>
              </div>
              ...
              <div className="mt-auto p-3.5 rounded-xl bg-rose-50/70 border border-rose-100 flex items-start space-x-3 text-left">
                ...
                <p className="text-xs text-rose-800 font-normal leading-relaxed">
                  Resulting in low attention spans, lack of focus on homework,
                  and chronic evening device dependency.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="group relative bg-white border border-[#E5E7EB] hover:border-slate-200 rounded-2xl hover:shadow-xl transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-2xs">
            ...
            <div className="relative w-full h-[180px] sm:h-[240px] overflow-hidden rounded-t-2xl">
              ...
              {/* Floating Header Badges */}
              <div className="absolute top-3 left-3 right-3 flex items-center justify-between z-10">
                <div className="flex items-center space-x-1.5 bg-[#22C55E]/20 backdrop-blur-md px-2.5 py-1 rounded border border-[#22C55E]/35 text-white">
                ...
                <span className="px-2.5 py-1 rounded bg-emerald-500/20 backdrop-blur-md border border-[#E5E7EB]-500/30 text-[9px] sm:text-[10px] font-mono font-bold text-emerald-300 tracking-wide select-none">
              ...
              <div className="space-y-4 text-left">
                <div className="flex items-start space-x-3.5">
                  ...
                  <div className="text-xs sm:text-[13px] font-normal text-slate-500 leading-relaxed">
                    ...
                    Children willingly stop entertainment to solve curriculum
                    quest challenges and earn focus slots independently.
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div className="text-xs sm:text-[13px] font-normal text-slate-500 leading-relaxed">
                    <span className="font-bold text-[#1E293B] block text-sm mb-0.5">
                      Promotes Active Cognitive Engagement
                    </span>
                    Custom mathematics, grammar, astronomy, and science overlays
                    keep kids actively practicing core concepts daily.
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-3.5">
                  ...
                  <div className="text-xs sm:text-[13px] font-normal text-slate-500 leading-relaxed">
                    <span className="font-bold text-[#1E293B] block text-sm mb-0.5">
                      Productive Learning Balance
                    </span>
                    Screen locks encourage children to deliberate before opening
                    apps, switching attention to math challenges first.
                  </div>
                </div>
              </div>

              {/* Bottom info panel with React Icon */}
              <div className="mt-auto p-3.5 rounded-xl bg-emerald-50/70 border border-[#E5E7EB]-100/60 flex items-start space-x-3 text-left">
                ...
                <p className="text-xs text-emerald-850 font-normal leading-relaxed">
                  Resulting in a 41% average reduction in idle scroll time, and
                  a huge confidence peak in school curriculum exams.
                </p>
              </div>
            </div>
          </div>
