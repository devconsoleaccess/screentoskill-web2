...
const steps = [
  {
    ...
    subDescription:
      "Secure parent credentials, kid profile, and safe onboarding.",
  ...
  },
  {
    ...
    subDescription:
      "Grant Accessibility, Overlay, and Usage access to run overlays.",
  ...
  },
  {
    ...
    subDescription:
      "Choose which highly engaging apps will trigger ScreenToSkill overlays.",
  ...
  },
  {
    ...
    subDescription:
      "Schedule specific lock windows or custom focus periods easily.",
  ...
  },
  {
    ...
    subDescription:
      "Every correct solution logs progress analytics and unlocks time.",
...
export default function HowItWorks() {
  ...
  return (
    <section
      id="how-it-works"
      className="relative py-14 sm:py-20 lg:py-24 bg-slate-50/20 border-b border-[#E5E7EB] overflow-hidden"
    >
      ...
      <div className="absolute top-[20%] left-[10%] w-[250px] h-[250px] rounded-full bg-[#22C55E]/15 blur-[80px] -z-10 animate-pulse duration-[8s]" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div className="text-center space-y-3 max-w-2xl mx-auto mb-14 sm:mb-18">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full border border-[#E5E7EB]-100 bg-emerald-50 text-xs font-semibold text-emerald-700">
          ...
          <p className="text-slate-500 text-xs sm:text-sm leading-relaxed font-normal">
            Convert addictive screen time fights into an automatic academic
            feedback loop. Setup takes just 3 minutes.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`group relative bg-[#FAFCFC]/90 backdrop-blur-md border rounded-[24px] p-5 sm:p-6 transition-all duration-300 cursor-pointer flex flex-col justify-start min-h-[390px] sm:min-h-[410px] overflow-visible ${
                  isActive
                    ? "border-[#22C55E] shadow-2xl shadow-emerald-500/10 -translate-y-1.5"
                    : "border-slate-200/70 hover:border-[#22C55E] hover:shadow-2xl hover:shadow-emerald-500/10 hover:-translate-y-1.5"
                }`}
              >
                {/* Floating Step Number Circle - Top Left Corner overlapping card border */}
                <div className="absolute -top-3.5 -left-3.5 w-10.5 h-10.5 rounded-full bg-[#22C55E] text-white flex items-center justify-center font-display font-bold text-sm sm:text-base shadow-lg shadow-emerald-500/30 z-20 select-none">
                  {step.id}
                </div>
                ...
                <div className="relative h-[340px] w-full rounded-2xl bg-slate-50 overflow-hidden flex items-center justify-center mb-4 select-none border border-slate-200/60 p-2">
                  ...
                  <div className="absolute top-3.5 left-3.5 inline-flex items-center px-2.5 py-1 rounded bg-white text-[10px] font-mono font-bold text-[#22C55E] tracking-wider select-none uppercase border border-[#E5E7EB]-100/80 shadow-md z-20">
                    {step.stepBadge}
                  </div>
                ...
                <div className="text-left flex flex-col justify-start">
                  <h3 className="font-display font-bold text-slate-900 text-sm sm:text-base group-hover:text-[#22C55E] transition-colors leading-tight mb-2">
                    {step.title}
                  </h3>
