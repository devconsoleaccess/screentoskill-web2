...
import { Shield, CheckCircle, Clock, ArrowUpRight } from "lucide-react";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-6 space-y-5 text-center lg:text-left">
              ...
              <p className="text-xs sm:text-sm text-slate-500 max-w-lg mx-auto lg:mx-0 leading-relaxed font-normal text-center lg:text-left">
                ...
                Convert addictive scrolling into curriculum-aligned active
            ...
            >
              ...
              <div className="relative w-full flex justify-center items-center h-[380px] sm:h-[500px] lg:h-[580px] perspective-[1200px] overflow-visible">
                ...
                <div
                  ...
                  style={{
                    transform:
                      "perspective(1200px) rotateY(15deg) scale(0.85) translateX(-185px)",
                ...
                {/* MIDDLE MOCKUP */}
                <div
                  className="relative overflow-hidden flex flex-col z-20 transition-all duration-500 hover:scale-102 hover:shadow-emerald-500/10 group"
                  style={{
                ...
                >
                  <div className="relative w-full h-full overflow-hidden">
                    <Image
                      ...
                      fill
                      priority
                      sizes="(max-width: 640px) 200px, (max-width: 1024px) 240px, 290px"
                      className="object-cover group-hover:scale-99 transition-transform duration-500"
                      referrerPolicy="no-referrer"
                    />
                ...
                <div
                  ...
                  style={{
                    transform:
                      "perspective(1200px) rotateY(-15deg) scale(0.85) translateX(165px)",
                    transformStyle: "preserve-3d",
                  }}
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center divide-y md:divide-y-0 md:divide-x divide-slate-100">
            <div className="py-2.5 md:py-0">
              <span className="block text-2xl sm:text-3xl font-bold text-slate-800">
                100k+
              </span>
              ...
              <p className="text-[11px] text-slate-400 max-w-xs mx-auto mt-1 font-normal leading-relaxed">
                Nurturing high-performance study habits and reducing device
                dependencies daily.
              </p>
            </div>

            <div className="py-2.5 md:py-0">
              <span className="block text-2xl sm:text-3xl font-bold text-[#22C55E]">
                5M+
              </span>
              <span className="text-[10px] uppercase tracking-wider font-mono text-slate-400 font-bold block mt-1">
                Correct MCQ Quests
              ...
              <p className="text-[11px] text-slate-400 max-w-xs mx-auto mt-1 font-normal leading-relaxed">
                Our comprehensive curriculum empowers core skill tracking
                dynamically.
              </p>
            </div>
            ...
            <div className="py-2.5 md:py-0">
              ...
              <p className="text-[11px] text-slate-400 max-w-xs mx-auto mt-1 font-normal leading-relaxed">
                Replaced addictive brain rot with constructive mental fitness
                workouts.
              </p>
            </div>
          </div>
