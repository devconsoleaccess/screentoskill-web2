...
export default function MandatoryPermissions() {
  return (
    <section
      ...
      className="relative py-24 sm:py-32 bg-white border-b border-[#E5E7EB] overflow-hidden"
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto mb-20">
          <div className="inline-flex items-center space-x-2 px-3 py-1 rounded-full border border-[#E5E7EB]-100 bg-emerald-50 text-[11px] font-mono font-extrabold text-[#22C55E] tracking-wider uppercase select-none">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-[2.6rem] font-display font-black text-slate-900 tracking-tight leading-tight">
            Mandatory{" "}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#22C55E] to-emerald-600">
              System Permissions
            </span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-10 pt-4">
          ...
          <div className="group relative bg-[#FAFCFC]/90 backdrop-blur-md border border-slate-200/90 hover:border-[#22C55E]/40 rounded-[1.8rem] sm:rounded-[2.2rem] p-5 sm:p-7 transition-all duration-300 flex flex-col justify-between min-h-[380px] sm:min-h-[460px] overflow-visible">
            ...
            <div
              className="absolute -top-3.5 -left-3.5 sm:-top-5 sm:-left-5 w-8.5 h-8.5 sm:w-11 sm:h-11 rounded-full bg-[#22C55E] text-white flex items-center justify-center font-display font-black text-sm sm:text-lg shadow-lg shadow-emerald-500/30 z-20 select-none animate-bounce"
            ...
            <div>
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="text-[10px] text-[#22C55E] font-black font-mono tracking-wider">
                  REQUIRED
                </span>
              </div>
              ...
              <div className="h-[135px] sm:h-[155px] w-full bg-slate-900 border border-slate-800 rounded-2xl sm:rounded-2.5xl relative overflow-hidden flex flex-col p-3.5 mb-6 shadow-inner">
                <div className="flex items-center justify-between border-b border-slate-800 pb-2 mb-3">
                  ...
                  <span className="text-[8.5px] font-bold px-1.5 py-0.2 rounded bg-emerald-500/10 text-[#22C55E]">
                ...
                <div className="space-y-2 text-left text-[9px] font-semibold">
                  <div className="bg-slate-800/25 p-2 rounded-lg border border-slate-800 flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      <div className="w-5 h-5 bg-[#22C55E] rounded flex items-center justify-center text-[10px] text-white font-bold leading-none">
                        S
                      </div>
              ...
              <div className="text-left">
                ...
                <p className="text-[12.5px] text-slate-500 mt-2 font-semibold leading-relaxed">
                  ...
                  within Accessibility Settings. This allows instant launcher
                  interception to intercept restricted social screens in under
                  10 milliseconds.
                </p>
              </div>
            </div>
            ...
            <div className="border-t border-slate-150 pt-3.5 mt-5 flex items-center justify-between">
              <span className="text-[9.5px] text-slate-400 font-bold tracking-wider uppercase font-mono">
                SYSTEM MONITOR INTERFACE
              </span>
              <span className="text-[10px] text-[#22C55E] font-black font-mono">
                STEP 1 COMPLETE ✓
              </span>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="text-left">
                ...
                <p className="text-[12.5px] text-slate-500 mt-2 font-semibold leading-relaxed">
                  ...
                  . This ensures the customized gamified quiz popup displays
                  instantly on top of addictive games.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="text-left">
                ...
                <p className="text-[12.5px] text-slate-500 mt-2 font-semibold leading-relaxed">
                  ...
                  . This permits our software to calculate cumulative screen
                  time metrics and trigger block layers accurately.
                </p>
              </div>
            </div>
