...
export default function BrainDevelopmentImpact() {
  ...
  return (
    <section
      id="brain-impact"
      className="relative py-14 sm:py-20 lg:py-24 bg-white border-b border-[#E5E7EB] overflow-hidden"
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-4 text-left">
            ...
            <p className="text-slate-505 text-xs sm:text-sm leading-relaxed font-normal">
              ...
              into active mental exercises verified by neurodevelopment
              research.
            </p>

            <div className="p-4 bg-slate-50 border border-[#E5E7EB] rounded-xl space-y-1.5">
          ...
          <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            {impacts.map((item, index) => (
              <div
                key={index}
                className="group relative bg-white border border-[#E5E7EB] hover:border-slate-200/60 p-5 rounded-xl hover:shadow-lg transition-all duration-300 flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between"
              >
                ...
                {/* Stat Display Box */}
                <div className="sm:text-right w-full sm:w-auto mt-2 sm:mt-0 pt-3 sm:pt-0 border-t sm:border-t-0 border-[#E5E7EB] flex sm:flex-col justify-between items-center sm:items-end shrink-0">
