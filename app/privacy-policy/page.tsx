...
const SECTIONS: PolicySection[] = [
  {
    ...
    body: (
      <>
        ...
        This may include your name, email address, your child&apos;s first
        name, age or grade level, and learning progress data such as quiz
        scores and completed challenges. We do not knowingly collect more
        personal information from children than is reasonably necessary to
  ...
  },
  {
    ...
    body: (
      <>
        ...
        ScreenToSkill, personalize learning content to your child&apos;s age
        and grade level, track progress and award in-app rewards, communicate
        with parents about account activity, and maintain the safety and
  ...
  },
  {
    ...
    body: (
      <>
        ...
        review, update, or delete their child&apos;s profile information at
        any time from the account dashboard. We never allow children to make
  ...
  },
  {
    ...
    body: (
      <>
        ...
        with applicable children&apos;s privacy laws, including the
        Children&apos;s Online Privacy Protection Act (COPPA) where
        applicable. We do not knowingly sell or share children&apos;s
        personal information with third parties for advertising purposes,
        and we do not display behavioral advertising to children within the
        app.
      </>
    ),
  },
  {
    ...
    body: (
      <>
        We do not sell your personal information or your child&apos;s
        personal information. We may share limited information with trusted
        service providers who help us operate the app, such as hosting and
        analytics providers, and only to the extent necessary to provide our
  ...
  },
  {
    ...
    body: (
      <>
        We retain account and learning progress information for as long as
        your account remains active or as needed to provide our services. You
  ...
  },
  {
    ...
    body: (
      <>
        ...
        correct, export, or delete your personal information, and your
        child&apos;s personal information, held by ScreenToSkill. To exercise
  ...
  },
  {
    ...
    body: (
      <>
        ...
        parents of material changes by posting the updated policy on this
...
export default function PrivacyPolicyPage() {
  return (
    ...
    <Section id="privacy-policy" tone="subtle" bordered className="bg-[#FBFDFF]/80 dark:bg-slate-950/40">
      <Container>
